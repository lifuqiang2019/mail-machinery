...
export class Migration20251125163316 extends Migration {

  override async up(): Promise<void> {
    this.addSql(`create table if not exists "message" ("id" text not null, "order_id" text not null, "sender_type" text check ("sender_type" in ('customer', 'admin')) not null, "content" text not null, "created_at" timestamptz not null default now(), "updated_at" timestamptz not null default now(), "deleted_at" timestamptz null, constraint "message_pkey" primary key ("id"));`);
